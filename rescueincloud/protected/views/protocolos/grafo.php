<?php 
    echo "<script src='js/cajas.js'></script>"

?>    


<input id="demo" type="button" value="Mostrar demo" />
...
<button id="crear" type="button">Crear caja</button>
<hr>
...
<button id="crear_relacion" type="button">Crear nueva relación</button>
<div id="canvas"></div>
